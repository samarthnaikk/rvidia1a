    ...
    <section className="relative min-h-screen w-full bg-[#040811] px-6 pb-10 pt-8 text-slate-100 md:px-10 lg:px-14">
      <div className="mx-auto w-full max-w-[1000px] rounded-[12px] border border-white/15 bg-[#0b1322d9] p-6">
        <div className="mb-8 flex items-center justify-between">
          <h1 className="text-[34px] font-bold text-slate-100">
            Submit GPU Job
          </h1>
          <button
        ...
        {errorMessage && (
          <p className="mb-4 text-[13px] text-red-300">{errorMessage}</p>
        )}
        {successMessage && (
          <p className="mb-4 text-[13px] text-emerald-300">{successMessage}</p>
        )}
